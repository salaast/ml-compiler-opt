...
def train(modules=range(3), num_workers=3, num_iter=1, arg=1, kwarg=2, policy=1):
    ...
    JobStep, num_workers, arg, kwarg=kwarg) as pool:
        for _ in range(num_iter):
            ...
            jobs=[(module, p) for module in modules for p in (p1, p2)], worker_pool=pool)
            ...
            while not_done:
                ...
                # logging.info("done:",done,"not done:",not_done)
